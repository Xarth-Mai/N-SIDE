...
读取[美术规格](../../../docs/dev/production/art-direction.md)、[资产管理](../../../docs/dev/production/asset-pipeline.md)、相关资产包 README 和现有导出脚本，先确认本机 Blender 与需要的操作能力是否实际可用
...
6. **实际复验**：使用[工程检查](../../../game/README.md)核对模型和必需贴图，再按[运行验收](../../../docs/dev/validation/runtime.md)捕获真实加载与动作。模型无动画时不声称动画通过；没有 Blender 时仍可检查既有 GLB 与引用，并明确 DCC 操作未运行
