...
Uses the retained create-game-assets inspection helper (local color-budget patch documented in the manifest); see
...
source revision and retained license are listed in docs/dev/decisions/asset-tools.md.
"""
