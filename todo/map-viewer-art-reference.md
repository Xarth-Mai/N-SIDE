...
核验日期：2026-09-25；本轮研究服务于 [TASK-003](archive/map-viewer.md)，正式制作规则维护于[美术](../docs/dev/production/art-direction.md)
...
[正式美术规范](../docs/dev/production/art-direction.md)将参考提取为 N:SIDE 的建筑、经营图形、颜色、材质和生活物件规则；角色及 UI 只保留与环境协调的原则，完整游戏的昼夜方向与 Viewer 首版仅白天的范围分别维护
