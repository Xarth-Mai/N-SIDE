...
维护十条主线与当前十二条街坊故事的单一关系源、条件推演、Wiki 时间轴和逐篇详情；新增故事由 TASK-022 同步接入

## 验收条件

关系语义、引用与可进入性校验通过，当前二十二篇接入，Wiki 双站与文档检查通过；桌面、手机与键盘路径观察另留证据

## 当前工作与下一步

第 5 轮已将 87 篇百科正文迁至 player 直属目录，原文保留并兼容旧地址；519 项线上检查覆盖全部当前页面、旧 URL 与资源。TASK-022 随叙事更新将当前范围扩为二十二篇；上述线上结果只对应原版本，尚未发布本轮内容。下一步仍是在可用浏览器中补齐桌面、手机与键盘交互验收
