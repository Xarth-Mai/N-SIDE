...
- [ ] [TASK-022 故事整合与正式命名迁移](tasks/TASK-022-story-and-naming.md) · `active` · DOCS-PIPELINE：第 1 轮，步骤 3/6 制作；先提交命名与人物世界基线，再提交完整故事，最后提交规格与数据回归。白沙河保留，LATE BITE 对应场所 82，其余候选已由作者确认，无新增命名待选
