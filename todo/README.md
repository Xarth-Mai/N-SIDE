...
- [ ] `in_progress` [项目总路线图：至可玩 Demo](demo-roadmap.md)：M0-01 已验收，当前细化 M0-02《最后的玩具》，轮次与验收数见[进度看板](demo-progress.md)

状态：`backlog` 待安排、`ready` 可执行、`in_progress` 制作中、`blocked` 等待依赖、`done` 已交付、`cancelled` 已取消
...
- [x] `done` [3D Map Viewer 与最小世界运行时](archive/map-viewer.md)：按已交付范围结项，剩余工作见 [Demo 承接](demo-roadmap.md#城市与-viewer-归档承接)

- `cancelled` [N街区空间深化](archive/n-district-space.md)：已由 [TASK-002](archive/n-district-modern-city.md)替代，后续统一见 Demo 路线图
