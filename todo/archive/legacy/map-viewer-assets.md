...
首批 Kenney 与 ambientCG 子集已取得并导出，精确文件、原件哈希、米制和材质调整见[环境素材包](../../../source-assets/environment-kit/README.md)；可复现导出、Bevy 异步依赖加载及六镜头窗口渲染检查 PASS。全图基础外观与店面首轮画面已检查，样板美术验收仍待作者确认，替补与待核条目保持 `candidate`，性能及限制见[实际验证记录](map-viewer.md#实际验证记录)
